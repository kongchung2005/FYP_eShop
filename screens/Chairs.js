...
import ChairsImages from '../constants/images/Chairs';
  ...
  renderProducts = () => {
    return (
      <ScrollView
        ...
        <Block flex>
          <Product product={ChairsImages[0]} horizontal />
          <Block flex row>
            <Product product={ChairsImages[1]} style={{ marginRight: theme.SIZES.BASE }} />
            <Product product={ChairsImages[2]} />
          </Block>
          <Product product={ChairsImages[3]} horizontal />
          <Product product={ChairsImages[4]} full />
        </Block>
      </ScrollView>
    )
  }
