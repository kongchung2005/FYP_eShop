...
import BedsImages from '../constants/images/Beds';
  ...
  renderProducts = () => {
    return (
      <ScrollView
        ...
        <Block flex>
          <Product product={BedsImages[0]} horizontal />
          <Block flex row>
            <Product product={BedsImages[1]} style={{ marginRight: theme.SIZES.BASE }} />
            <Product product={BedsImages[2]} />
          </Block>
          <Product product={BedsImages[3]} horizontal />
          <Product product={BedsImages[4]} full />
        </Block>
      </ScrollView>
    )
  }
