...
import DesksImages from '../constants/images/Desks';
  ...
  renderProducts = () => {
    return (
      <ScrollView
        ...
        <Block flex>
          <Product product={DesksImages[0]} horizontal />
          <Block flex row>
            <Product product={DesksImages[1]} style={{ marginRight: theme.SIZES.BASE }} />
            <Product product={DesksImages[2]} />
          </Block>
          <Product product={DesksImages[3]} horizontal />
          <Product product={DesksImages[4]} full />
        </Block>
      </ScrollView>
    )
  }
